            ...
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input name="password_confirmation" type="password" class="form-control form-control-user @error('password_confirmation')is-invalid @enderror" id="exampleRepeatPassword" placeholder="Kata Sandi">
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="{{ route('login') }}">Sudah Punya Akun Dukcapil? Login!</a>
              </div>
            </div>
          </div>
        </div>
